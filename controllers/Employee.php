...
class Employee extends MY_Controller {
    ...
    public function emp_profile($id) {
        ...
        //print_r($data['menu_detail']); die();
        $data['screen'] = 'profile';
        $json['employee_html'] = $this->load->view('employee/index', $data);
    ...
    public function add_new_employee() {
        ...
        $this->form_validation->set_rules('category', 'Employee Category', 'required|is_unique[employees.email]|xss_clean');
    ...
    {
        $origins = $this->Employee_model->get_state_origins($state_id);
        $options = "";
    ...
    {
        $states = $this->Employee_model->get_country_states($country_id);
        $options = "";
