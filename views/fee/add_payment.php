<form role="form" id="add_fee_payment_form" method="post"
            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="date_payment" name="date" value="<?php echo isset($fee_date)?$fee_date:''; ?>" autocomplete="off" />
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <select class="form-control" id="status" name="status" required>
                                ...
                                <?php foreach ($fee_status as $status) { ?>
                                    <option value="<?php echo $status['id'] ?>"
                                        <?php echo isset($status)&& $status==$status['id']?'selected' :''; ?>><?php echo $status['status'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
