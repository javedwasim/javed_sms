       ...
       <div class="col-md-12">
        <div class="card card-primary">
         ...
         <div class="card-body">
           <div class="row">
                <div class="col-md-4">
                  <button type="button" class="btn btn-primary" id="list_itmes_students"><i class="fa fa-plus"></i>Add Student</button>
                </div>
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" name="search-employee" id="search-employee"
                           onchange="student_filters()"  class="form-control" value="<?php echo isset($filters['search-employee'])?$filters['search-employee']:'';?>">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                ...
                <div class="col-md-3 filter-toggle">
                  ...
                  <div class="col-md-3 filter-toggle">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control datepicker" id="admit_date" name="admit_date" onchange="student_filters()" value="<?php echo isset($filters['admit_date'])?$filters['admit_date']:'';?>">
                    </div>
                  </div>
                  <div class="col-md-3 filter-toggle">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control datepicker" id="emp-li-dob" name="dob" onchange="student_filters()" value="<?php echo isset($filters['dob'])?$filters['dob']:'';?>">
                    </div>
                  </div>
                  ...
                  <div class="col-md-3">
                    <div class="form-group mt-3">
                      <button type="button" class="btn btn-info btn-md" id="filter"><i class="fa fa-search"></i>Search</button>
                    </div>
                  </div>
                </div>
              </form>
              ...
              <div class="row">
                ...
                <div class="col-md-2"></div>
                <div class="col-md-4">
                  <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-print"></i>Print PDF</button>
                </div>
              </div>
              <hr>
             <table id="student-b-table" class="table table-bordered table-striped nowrap" style="width: 100%;">
               <thead>
                 <tr>
                   <th>Name</th>
               ...
               <tbody>
                ...
                <tr>
                  <td>
                    <a  class="prof-link" href="<?php echo site_url('students/student_profile/').$student['student_id'] ?>"><?php echo $student['surname'].', '.$student['first_name'] ?></a>
                  </td>
                  <td class="visibility">
                  ...
                  <td>
                    ...
                    <a class="edit-studentsss btn btn-info btn-xs"  href="javascript:void(0)" ><i class="fa fa-user-plus"></i> Select</a>
                  </td>
                </tr>
                <?php } ?>
              </tbody>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label>Title</label>
              <input type="text" name="" class="form-control" placeholder="Stident List" maxlength="15" >
            </div>
          </div>
          <hr>
          <div class="col-md-12">
      ...
      <div class="modal-footer">
        <div class="col-md-6 text-center">
          <a href="<?php echo base_url(); ?>students/createPdf" target="_blank" type="button" class="btn btn-primary">Generate PDF</a>
        </div>
      </div>
    </div>
  </div>
