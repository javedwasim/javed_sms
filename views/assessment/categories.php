            ...
            <form id="update_assessment_category_form" method="post" role="form"
                ...
                <div class="modal-body mx-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="category_name" name="name" class="form-control validate">

                    </div>
                    <div class="form-group">
                        <label for="category_abbreviation" class="col-form-label">Description:</label>
                        <input type="text" id="category_abbreviation" name="abbreviation" class="form-control validate" >

                    </div>
                    <div class="modal-footer d-flex justify-content-center">
                        <button id="update_assessment_category" type="submit" class="btn btn-default">Save Assessment Category</button>
                    </div>
                </div>
            </form>
        </div>
