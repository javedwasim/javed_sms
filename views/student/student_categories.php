        ...
        <div class="col-md-12">
          <div class="card card-primary">
             ...
             <div class="card-body">
              <div class="row">
                <div class="col-md-4">
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#setting_category_model"><i class="fa fa-plus"></i>New Student Category</button>
                </div>
              </div>
              <hr>
                ...
                <tbody>
                  <?php foreach ($categories as $category){ ?>
                      <tr>
                        ...
                        <td>
                          <a href="javascript:void(0)" class="btn btn-primary btn-xs" id="<?php echo $category['category']; ?>" onclick="save_category(<?php echo $category['id']; ?>,'<?php echo $category["category"]; ?>')"><i class="fa fa-edit icon-margin"></i></a>
<!--                          <a href="javascript:void(0)" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete</a>-->
                          <a class="delete-student_cate btn btn-danger btn-xs" href="javascript:void(0)" data-href="<?php echo site_url('student_setting/delete_category/').$category['id'] ?>"><i class="fa fa-trash icon-margin" title="Delete"></i></a>
                        </td>
                      </tr>
                 <?php } ?>
                </tbody>
  ...
  <div class="container">
    <div class="modal fade" id="setting_category_model" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
