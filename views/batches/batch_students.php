                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content">
                                <div class="active tab-pane" id="activity">
                                    ...
                                    <div id="student_grade_scale_container">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <!-- /.card-header -->
                                                ...
                                                <tbody>
                                                    <?php foreach ($students as $student): ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="btn btn-xs btn-info std_profile" target="_blank"
                                                                   data-student-id="<?php echo $student['student_id']; ?>"
                                                                   data-href="<?php echo base_url()."students/profile/".$student['student_id']; ?>">
...
<script>
    ...
    $(document.body).on('change', '#term_filter', function(){
       var term_id = $('#term_filter').val();
       var batch_id = $('#sbatch_id').val();
       $('#term_id').val(term_id);
       var base_url = $('#base').val();
       $.ajax({
            url: base_url+'batches/term_demographics',
            type: 'post',
            data: {term_id:term_id,batch_id:batch_id},
            cache: false,
            success: function(response) {
                if(response.result_html != ''){
                    $('#student_grade_scale_container').empty();
                    $('#student_grade_scale_container').append(response.result_html);
                    $('.student_grade_link:first-child').click();
                }else{
