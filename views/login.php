<?php
 ...
 $user_name = $this->input->cookie('username',TRUE);
        ...
        <form action="<?php echo base_url(); ?>dashboard/login" method="post" class="login100-form validate-form" autocomplete="off" >
          ...
          <div class="wrap-input100 validate-input" data-validate = "Enter username">
            <input class="input100" type="text" name="email" placeholder="Username"
                   autocomplete="off" value="<?php echo !empty($user_name)?$user_name:''; ?>">
            <span class="focus-input100" data-placeholder="&#xf207;"></span>
          </div>

          <div class="wrap-input100 validate-input" data-validate="Enter password">
            <input class="input100" type="password" name="password" placeholder="Password"
                   autocomplete="off" value="<?php echo !empty($password)?$password:''; ?>">
            <span class="focus-input100" data-placeholder="&#xf191;"></span>
          </div>
          ...
          <div class="contact100-form-checkbox">
            ...
            <input class="input-checkbox100" id="ckb1" type="checkbox" name="remember-me" <?php echo !empty($user_name)?'checked':''; ?> >
          </div>
