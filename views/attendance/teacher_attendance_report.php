...
>>>>>>> 5a94356c82c190f32621ca477f3e6d39d612397d
                    ...
                    <div class="col-md-3">
                        <button id="emp_attendance_report_btn" type="submit" class="btn btn-primary btn-md <?php echo $role == 'Subject Teacher'?'disabled':''; ?>">
                            <i class="fa fa-search"></i> View Attendance</button>
                    </div>
                </div>
            </form>
        </div>
